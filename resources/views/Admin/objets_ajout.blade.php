    ...
    <div class="page-header-content d-lg-flex border-top">
						<div class="d-flex">
							<div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.objet.index') }}" class="breadcrumb-item active">Ajouter un objet</a>
...
<div class="card">
    <div class="card-header text-center">
        <h1 class="title-profil d-inline-block">
            <i class="fas fa-file-alt me-2"></i> Gestion des Objets
        </h1>
    </div>
           @if(session('success'))
        ...
        <div style="background: #f8f9fa; padding: 20px; border-radius: 12px; border: 1px solid #ddd; margin-bottom: 30px;">
            ...
            <form method="POST" action="{{ route('admin.objet.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nom" id="nom" class="form-control" placeholder="Ex : Demande de congé" required>
                </div>
