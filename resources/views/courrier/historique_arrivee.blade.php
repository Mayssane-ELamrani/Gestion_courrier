...
@endif
                                ...
                                <a href="{{ route('courrier.arrivee.form', ['espace' => $espace]) }}?phase2={{ $courrier->id }}" class="btn-action">
                                    Phase 2
                                </a>
                            </div>
                            <br>
                        <div style="display: flex; flex-direction: column; gap: 6px;">
                            <div style="display: flex; gap: 8px; justify-content: center;">
                                <a href="{{ route('courrier.arrivee.form', ['espace' => $espace]) }}?edit={{ $courrier->id }}" class="btn-action">
                                    Modifier
                                </a>
                                <a href="{{ route('courrier.arrive.historique', ['espace' => $espace]) }}?search={{ $courrier->reference }}" class="btn-action">
                                    Détails
                                </a>
                            </div>
