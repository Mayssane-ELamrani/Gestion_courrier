    ...
    <div class="page-header-content d-lg-flex border-top">
						<div class="d-flex">
							<div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.utilisateur.index') }}" class="breadcrumb-item active">Ajouter un utilisateur</a>
...
@endif
            ...
            <form method="POST" action="{{ route('admin.utilisateur.store') }}" class="row g-3">
                @csrf
                <div class="col-md-6">
                ...
                <div class="col-md-12 d-flex justify-content-end">
                    <button type="submit" class="btn btn-success">
                        <i class="fas fa-plus-circle me-1"></i> Créer l'utilisateur
                    </button>
                </div>
            </form>
        </div>
